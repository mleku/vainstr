...
const prefix = bech32encoding.PubHRP + "1"
...
var log = slog.New(os.Stderr, "vainstr")
...
func mine(str string, where int, quit qu.C, resC chan Result, wg *sync.WaitGroup, counter *atomic.Int64) {
